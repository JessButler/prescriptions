...
All prescribing data were downloaded from here https://www.opendata.nhs.scot/dataset/prescriptions-in-the-community  

A drug is defined as all medication with the same BNF chemical substance name (regardless of dose). 

A drug class is all medication in the same BNF section.  

BNF data were downloaded from here https://applications.nhsbsa.nhs.uk/infosystems/data/showDataSelector.do?reportId=126

Number of prescriptions and costs per item was calculated as specified here https://www.isdscotland.org/Health-topics/Prescribing-and-medicines/_docs/Open_Data_Glossary_of_Terms.pdf?1 
